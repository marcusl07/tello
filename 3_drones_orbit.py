...
x1 = int(math.cos(degrees/2)*radius)
y1 = int(math.sin(degrees/2)*radius)
z1 = 0

x2 = int(math.cos(degrees)*radius)
y2 = int(math.sin(degrees)*radius)
z2 = 0
...
send(f'forward {radius-20}', 10)

for x in range(10):
    send(f'curve {x1} {y1} {z1} {x2} {y2} {z2} {speed}', 15)
